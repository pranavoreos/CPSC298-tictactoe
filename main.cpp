...
int main()
{
    ...
    if(game==1)
    {
        strcat(str," X starts first, would you like go 1st or 2nd?");
        puts(str);
    }
    else
    {
        
        strcpy(str,"\nThis time would you like to go 1st or 2nd, ");
        strcat(str,name);
        strcat(str,"?");
        puts(str);
    }
...
input:
        ...
        case 1:
            ...
            for(i=0;i<9;)
            {
                ...
                if(i>5)
                    ...
                    {
                        if(game>1)
                            strcat(str,", you couldn't beat me this time, I won.");
                        else
                            strcat(str,", I won, you lose.");
                        puts(str);
                        break;
                    }
            }
    ...
    {
        if(game>1)
            cout<<"Well Played!\nBut you couldn't beat me this time\n";
        else
            cout<<"Well Played!\nIt is a tie.\n";
